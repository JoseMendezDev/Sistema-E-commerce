...
import main.java.com.models.abstracto.Transporte;
...
public class Repartidor extends Usuario {
    ...
    public Transporte getVehiculo() { return vehiculo; }
    public void setVehiculo(Transporte vehiculo) { this.vehiculo = vehiculo; }
}
